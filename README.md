...
10. [11_LESSONS_FROM_GOING_LIVE.md](./docs/11_LESSONS_FROM_GOING_LIVE.md) - What the first deploy taught, the three bugs it exposed, and why the delivery trail is built the way it is
